...
import 'package:ohso3d/animated_example.dart';
import 'package:ohso3d/example_custom_painter.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const AnimatedExample()));
            },
          )
        ],
      ),
        ...
        ZWidget.builder(
          builder: (index) {
            return Container(
              ...
              child: Center(
                child: Text("$index", style: Theme.of(context).textTheme.headline3),
              ),
            );
          },
          rotationX: pi / 4,
